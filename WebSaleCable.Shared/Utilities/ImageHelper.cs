...
namespace NuWebForSaler.Shared.Utilities
{
    public class ImageHelper
    {
        ...
        public bool SaveCroppedImageProduct(Image image, string filePath, string fileName, ref Byte[] imageBytes, int maxWidth = 400)
        {
            //if (image.Width < maxWidth)
            //{
            //    return true;
        ...
        public bool SaveCroppedImageSilder(Image image, string filePath, string fileName, ref Byte[] imageBytes, int maxWidth = 400)
        {
            //if (image.Width < maxWidth)
            //{
            //    return true;
